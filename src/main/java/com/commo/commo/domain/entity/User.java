...
/**
 * Entidade que representa um usuário do sistema Commo. Implementa {@code UserDetails} para
...
public class User extends BaseAuditableEntity implements UserDetails {
    ...
    @Comment("ID do tenant ou organização no modelo multi-tenancy. Nulo para SUPER_ADMIN")
